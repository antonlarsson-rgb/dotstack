...
export function Slide01Hero() {
  return (
    <section
      id="slide-1"
      className="slide flex items-center justify-center py-20 md:py-24"
    >
      <motion.div
      ...
      >
        ...
        <motion.h1
          className="font-mono text-[48px] md:text-[80px] font-medium tracking-[-0.025em] text-[var(--text)]"
          variants={fadeUp}
        >
          .stack
        </motion.h1>
        ...
        <motion.p
          className="font-sans text-[22px] md:text-[32px] font-medium text-[var(--text)] leading-[1.2] mt-4 md:mt-6 tracking-[-0.015em]"
          variants={fadeUp}
        >
        ...
        <motion.p
          className="text-[15px] md:text-[19px] text-[var(--text-secondary)] leading-[1.4] mt-4 md:mt-6 max-w-[600px]"
          variants={fadeUp}
        >
